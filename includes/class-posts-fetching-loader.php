...
class Posts_Fetching_Loader {
	...
	public function add_shortcode( $tag, $callback ) {
		$this->shortcodes = $this->addShortcode( $this->shortcodes, $tag, $callback );
	}
	...
	private function addShortcode( $shortcodes, $tag, $callback ) {
	...
	public function run() {
		...
		foreach ( $this->shortcodes as $shortcode ) {
			var_dump( $shortcode['tag'] );
			var_dump( $shortcode['callback'] );
